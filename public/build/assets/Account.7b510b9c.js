import{r as x,u as A,R as e,L as s,d as T}from"./app.bc54160e.js";import{S as L,N as R,d as D,u as U,m as z,j as k,B,a as C,c as S,A as O,D as v}from"./Dropdown.fab11b48.js";const F=x.exports.createContext(null),H=["as","active","eventKey"];function V(i,a){if(i==null)return{};var l={},c=Object.keys(i),n,r;for(r=0;r<c.length;r++)n=c[r],!(a.indexOf(n)>=0)&&(l[n]=i[n]);return l}function K({key:i,onClick:a,active:l,id:c,role:n,disabled:r}){const f=x.exports.useContext(L),p=x.exports.useContext(R),u=x.exports.useContext(F);let m=l;const d={role:n};if(p){!n&&p.role==="tablist"&&(d.role="tab");const g=p.getControllerId(i!=null?i:null),b=p.getControlledId(i!=null?i:null);d[D("event-key")]=i,d.id=g||c,m=l==null&&i!=null?p.activeKey===i:l,(m||!(u!=null&&u.unmountOnExit)&&!(u!=null&&u.mountOnEnter))&&(d["aria-controls"]=b)}return d.role==="tab"&&(d["aria-selected"]=m,m||(d.tabIndex=-1),r&&(d.tabIndex=-1,d["aria-disabled"]=!0)),d.onClick=U(g=>{r||(a==null||a(g),i!=null&&f&&!g.isPropagationStopped()&&f(i,g))}),[d,{isActive:m}]}const G=x.exports.forwardRef((i,a)=>{let{as:l=B,active:c,eventKey:n}=i,r=V(i,H);const[f,p]=K(Object.assign({key:z(n,r.href),active:c},r));return f[D("active")]=p.isActive,k.exports.jsx(l,Object.assign({},r,f,{ref:a}))});G.displayName="NavItem";const W=x.exports.forwardRef(({bsPrefix:i,className:a,as:l=O,active:c,eventKey:n,disabled:r=!1,...f},p)=>{i=C(i,"nav-link");const[u,m]=K({key:z(n,f.href),active:c,disabled:r,...f});return k.exports.jsx(l,{...f,...u,ref:p,disabled:r,className:S(a,i,r&&"disabled",m.isActive&&"active")})});W.displayName="NavLink";const _=W,M=x.exports.forwardRef(({id:i,title:a,children:l,bsPrefix:c,className:n,rootCloseEvent:r,menuRole:f,disabled:p,active:u,renderMenuOnMount:m,menuVariant:d,...g},b)=>{const E=C(void 0,"nav-item");return k.exports.jsxs(v,{ref:b,...g,className:S(n,E),children:[k.exports.jsx(v.Toggle,{id:i,eventKey:null,active:u,disabled:p,childBsPrefix:c,as:_,children:a}),k.exports.jsx(v.Menu,{role:f,renderOnMount:m,rootCloseEvent:r,variant:d,children:l})]})});M.displayName="NavDropdown";const h=Object.assign(M,{Item:v.Item,ItemText:v.ItemText,Divider:v.Divider,Header:v.Header});function t(i){const{auth:a}=A().props;let l=a.permissions,c=!1;return i.forEach(function(n){l[n]&&(c=!0)}),c}function q(){var b,E,w;const{url:i,auth:a}=A(),l=async o=>{o.preventDefault(),T.Inertia.post("/logout")},c=o=>o==="/account/dashboard"?i==="/account/dashboard"||i==="/account":i.startsWith(o),n=o=>c(o)?"sidebar-item active":"sidebar-item",r=a==null?void 0:a.user,f=(a==null?void 0:a.roles)&&Array.isArray(a.roles)?a.roles:r!=null&&r.roles?r.roles.map(o=>typeof o=="string"?o:o.name):[],u=(o=>o.some(N=>f.includes(N)))(["admin","bendahara","admin wilayah","timver dpw","timver dpc"])||t(["roles.index","permissions.index","users.index","verifPengajuan.index","verifPengajuanDpw.index","verifPengajuanDpc.index","dpw.index","dpc.index","wilayah.index","pengurus.index"]),m=(b=r==null?void 0:r.roles)==null?void 0:b.find(o=>{const N=typeof o=="string"?o:o.name;return N&&N!=="member"}),d=(typeof m=="string"?m:m==null?void 0:m.name)||((w=(E=r==null?void 0:r.roles)==null?void 0:E[0])==null?void 0:w.name)||(r==null?void 0:r.status_anggota)||"Anggota",g=r!=null&&r.name?r.name.charAt(0).toUpperCase():"A";return e.createElement(e.Fragment,null,e.createElement("aside",{className:"ikatwi-sidebar"},e.createElement("div",{className:"sidebar-brand-box"},e.createElement(s,{href:"/account/dashboard",className:"brand-link"},e.createElement("div",{className:"brand-logo-frame"},e.createElement("img",{src:"/assets/images/logo.png",alt:"Logo IKATWI",className:"brand-logo-img"})),e.createElement("div",{className:"brand-meta"},e.createElement("div",{className:"brand-title-wrap"},e.createElement("span",{className:"brand-name"},"IKATWI"),e.createElement("span",{className:"brand-badge"},"PORTAL")),e.createElement("span",{className:"brand-tagline"},"Ikatan Terapis Wicara Indonesia")))),e.createElement("div",{className:"sidebar-user-card"},e.createElement("div",{className:"user-avatar-wrap"},e.createElement("div",{className:"user-avatar-circle"},g),e.createElement("span",{className:"user-status-dot",title:"Status Online"})),e.createElement("div",{className:"user-details"},e.createElement("span",{className:"user-fullname",title:(r==null?void 0:r.name)||"Anggota IKATWI"},(r==null?void 0:r.name)||"Anggota IKATWI"),e.createElement("div",{className:"user-meta-row"},e.createElement("span",{className:"user-role-label"},d),(r==null?void 0:r.no_anggota)&&e.createElement("span",{className:"user-id-badge"},r.no_anggota)))),e.createElement("nav",{className:"sidebar-nav-container"},e.createElement("div",{className:"nav-section"},e.createElement("div",{className:"nav-heading"},"MENU UTAMA"),e.createElement(s,{href:"/account/dashboard",className:n("/account/dashboard")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-th-large"})),e.createElement("span",{className:"item-label"},"Dashboard"))),(t(["categories.index"])||t(["dpw.index"])||t(["dpc.index"])||t(["wilayah.index"]))&&e.createElement("div",{className:"nav-section"},e.createElement("div",{className:"nav-heading"},"DATA MASTER"),t(["categories.index"])&&e.createElement(s,{href:"/account/categories",className:n("/account/categories")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-folder"})),e.createElement("span",{className:"item-label"},"Kategori")),t(["dpw.index"])&&e.createElement(s,{href:"/account/dpw",className:n("/account/dpw")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-landmark"})),e.createElement("span",{className:"item-label"},"Master DPW")),t(["dpc.index"])&&e.createElement(s,{href:"/account/dpc",className:n("/account/dpc")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-city"})),e.createElement("span",{className:"item-label"},"Master DPC")),t(["wilayah.index"])&&e.createElement(s,{href:"/account/wilayah",className:n("/account/wilayah")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-map-marked-alt"})),e.createElement("span",{className:"item-label"},"Wilayah DPW")),t(["wilayah.index"])&&e.createElement(s,{href:"/account/areadpc",className:n("/account/areadpc")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-map-signs"})),e.createElement("span",{className:"item-label"},"Wilayah DPC")),t(["videos.index"])&&e.createElement(s,{href:"/account/videos",className:n("/account/videos")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-play-circle"})),e.createElement("span",{className:"item-label"},"Video Manajemen"))),(t(["biodatas.index"])||t(["pengurus.index"])||t(["ekta.index"]))&&e.createElement("div",{className:"nav-section"},e.createElement("div",{className:"nav-heading"},"KEANGGOTAAN"),t(["biodatas.index"])&&e.createElement(s,{href:"/account/biodatas",className:n("/account/biodatas")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-id-card"})),e.createElement("span",{className:"item-label"},"Biodata Anggota")),t(["users.index"])&&e.createElement(s,{href:"/account/verifikasi-users",className:n("/account/verifikasi-users")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-user-check"})),e.createElement("span",{className:"item-label"},"Verifikasi Anggota Baru"),(a==null?void 0:a.pendingUsersCount)>0&&e.createElement("span",{className:"badge rounded-pill",style:{backgroundColor:"#ef4444",color:"#ffffff",fontSize:"0.65rem",fontWeight:700,padding:"0.15rem 0.45rem",boxShadow:"0 1px 2px rgba(239, 68, 68, 0.4)"}},a.pendingUsersCount)),t(["pengurus.index"])&&e.createElement(s,{href:"/account/pengurus",className:n("/account/pengurus")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-users-cog"})),e.createElement("span",{className:"item-label"},"Struktur Pengurus")),t(["ekta.index"])&&e.createElement(s,{href:"/account/ekta",className:n("/account/ekta")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-address-card"})),e.createElement("span",{className:"item-label"},"E-KTA Digital")),t(["ekta.index"])&&e.createElement(s,{href:"/account/sig",className:n("/account/sig")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-certificate"})),e.createElement("span",{className:"item-label"},"SIG Keanggotaan")),t(["videousers.index"])&&e.createElement(s,{href:"/account/materi",className:n("/account/materi")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-film"})),e.createElement("span",{className:"item-label"},"Materi Pembelajaran")),t(["videousers.index"])&&e.createElement(s,{href:"/account/donasi",className:n("/account/donasi")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-hand-holding-heart"})),e.createElement("span",{className:"item-label"},"Program Donasi"))),(t(["tagihan.index"])||t(["transactions.index"])||u)&&e.createElement("div",{className:"nav-section"},e.createElement("div",{className:"nav-heading"},"KEUANGAN & IURAN"),t(["tagihan.index"])&&e.createElement(s,{href:"/account/tagihan",className:n("/account/tagihan")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-receipt"})),e.createElement("span",{className:"item-label"},"Pusat Tagihan & Iuran"),e.createElement("span",{className:"item-badge-new"},"Iuran")),t(["transactions.index"])&&e.createElement(s,{href:"/account/transactions",className:n("/account/transactions")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-history"})),e.createElement("span",{className:"item-label"},"Riwayat Transaksi")),u&&e.createElement(s,{href:"/account/monitoring-iuran",className:n("/account/monitoring-iuran")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-chart-line"})),e.createElement("span",{className:"item-label"},"Monitoring Iuran Anggota"),e.createElement("span",{className:"badge rounded-pill",style:{backgroundColor:"#ecfdf5",color:"#059669",fontSize:"0.65rem",fontWeight:700,border:"1px solid #a7f3d0"}},"Tahunan"))),(t(["products.index"])||t(["kegiatan.index"]))&&e.createElement("div",{className:"nav-section"},e.createElement("div",{className:"nav-heading"},"KEGIATAN & EVENT"),t(["products.index"])&&e.createElement(s,{href:"/account/products",className:n("/account/products")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-calendar-alt"})),e.createElement("span",{className:"item-label"},"Daftar Kegiatan")),t(["kegiatan.index"])&&e.createElement(s,{href:"/account/kegiatan",className:n("/account/kegiatan")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-tasks"})),e.createElement("span",{className:"item-label"},"Agenda Kegiatan"))),(t(["documents.index"])||t(["ejurnal.index"])||t(["pengajuan.index"])||t(["verifPengajuan.index"])||t(["verifPengajuanDpw.index"])||t(["verifPengajuanDpc.index"])||t(["arsips.index"]))&&e.createElement("div",{className:"nav-section"},e.createElement("div",{className:"nav-heading"},"DOKUMEN & MUTASI"),t(["documents.index"])&&e.createElement(s,{href:"/account/documents",className:n("/account/documents")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-file-alt"})),e.createElement("span",{className:"item-label"},"Dokumen Kelengkapan")),t(["ejurnal.index"])&&e.createElement(s,{href:"/account/ejurnal",className:n("/account/ejurnal")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-book-open"})),e.createElement("span",{className:"item-label"},"E-Jurnal IKATWI")),t(["pengajuan.index"])&&e.createElement(e.Fragment,null,e.createElement(s,{href:"/account/pengajuan",className:n("/account/pengajuan")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-paper-plane"})),e.createElement("span",{className:"item-label"},"Pengajuan Mutasi")),e.createElement(s,{href:"/account/print",className:n("/account/print")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-print"})),e.createElement("span",{className:"item-label"},"Pengajuan Print"))),(t(["verifPengajuan.index"])||t(["verifPengajuanDpw.index"])||t(["verifPengajuanDpc.index"]))&&e.createElement("div",{className:"sub-section-box"},e.createElement("div",{className:"sub-heading"},"VERIFIKASI MUTASI"),t(["verifPengajuan.index"])&&e.createElement(s,{href:"/account/verifPengajuan",className:n("/account/verifPengajuan")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-check-circle"})),e.createElement("span",{className:"item-label"},"Verifikasi Utama")),t(["verifPengajuanDpw.index"])&&e.createElement(s,{href:"/account/verifPengajuanDpw",className:n("/account/verifPengajuanDpw")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-check-double"})),e.createElement("span",{className:"item-label"},"Verifikasi DPW")),t(["verifPengajuanDpc.index"])&&e.createElement(s,{href:"/account/verifPengajuanDpc",className:n("/account/verifPengajuanDpc")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-clipboard-check"})),e.createElement("span",{className:"item-label"},"Verifikasi DPC")),t(["verifPengajuan.index"])&&e.createElement(s,{href:"/account/arsips",className:n("/account/arsips")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-archive"})),e.createElement("span",{className:"item-label"},"Arsip Pengajuan")))),(t(["sliders.index"])||t(["roles.index"])||t(["permissions.index"])||t(["users.index"]))&&e.createElement("div",{className:"nav-section"},e.createElement("div",{className:"nav-heading"},"PENGATURAN SISTEM"),t(["sliders.index"])&&e.createElement(s,{href:"/account/sliders",className:n("/account/sliders")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-images"})),e.createElement("span",{className:"item-label"},"Banner Slider")),t(["roles.index"])&&e.createElement(s,{href:"/account/roles",className:n("/account/roles")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-shield-alt"})),e.createElement("span",{className:"item-label"},"Peran & Wewenang")),t(["permissions.index"])&&e.createElement(s,{href:"/account/permissions",className:n("/account/permissions")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-key"})),e.createElement("span",{className:"item-label"},"Hak Akses")),t(["users.index"])&&e.createElement(s,{href:"/account/users",className:n("/account/users")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-user-cog"})),e.createElement("span",{className:"item-label"},"Manajemen User"))),e.createElement("div",{className:"nav-section"},e.createElement("div",{className:"nav-heading"},"PORTAL & AKUN"),e.createElement(s,{href:"/",className:n("/")},e.createElement("div",{className:"item-icon-box"},e.createElement("i",{className:"fa fa-globe"})),e.createElement("span",{className:"item-label"},"Website Utama")))),e.createElement("div",{className:"sidebar-footer-box"},e.createElement("button",{onClick:l,className:"sidebar-logout-btn"},e.createElement("i",{className:"fa fa-sign-out-alt logout-icon"}),e.createElement("span",{className:"logout-text"},"Keluar Sistem")),e.createElement("div",{className:"sidebar-version-tag"},e.createElement("span",null,"IKATWI PORTAL"),e.createElement("span",null,"\u2022"),e.createElement("span",null,"v2.5")))),e.createElement("style",null,`
            ...
            `))}function Q({children:i}){var m,d,g,b,E,w,o,N,I,j,P;const{auth:a}=A().props,[l,c]=x.exports.useState(!1),n=y=>{y.preventDefault(),l?(document.body.classList.remove("sb-sidenav-toggled"),c(!1)):(document.body.classList.add("sb-sidenav-toggled"),c(!0))},r=async y=>{y.preventDefault(),T.Inertia.post("/logout")},f=(m=a==null?void 0:a.user)!=null&&m.name?a.user.name.charAt(0).toUpperCase():"A",p=((b=(g=(d=a==null?void 0:a.user)==null?void 0:d.roles)==null?void 0:g[0])==null?void 0:b.name)||((E=a==null?void 0:a.user)==null?void 0:E.status_anggota)||"Anggota",u=new Intl.DateTimeFormat("id-ID",{weekday:"long",day:"numeric",month:"long",year:"numeric"}).format(new Date);return e.createElement(e.Fragment,null,e.createElement("div",{className:"d-flex",id:"wrapper"},l&&e.createElement("div",{className:"sidebar-mobile-backdrop d-md-none",onClick:n,title:"Tutup Menu"}),e.createElement("div",{id:"sidebar-wrapper",className:"sidebar-container-col"},e.createElement(q,null)),e.createElement("div",{id:"page-content-wrapper",className:"content-container-col"},e.createElement("header",{className:"top-header-bar"},e.createElement("div",{className:"container-fluid p-0 d-flex justify-content-between align-items-center"},e.createElement("div",{className:"d-flex align-items-center gap-3"},e.createElement("button",{className:"header-toggle-btn",onClick:n,title:"Buka/Tutup Menu Sidebar",type:"button"},e.createElement("i",{className:"fa fa-bars"})),e.createElement("div",{className:"d-flex align-items-center gap-2"},e.createElement("div",{className:"d-flex flex-column"},e.createElement("div",{className:"d-flex align-items-center gap-2"},e.createElement("span",{className:"header-brand-title"},"Portal IKATWI"),e.createElement("span",{className:"header-status-badge"},e.createElement("span",{className:"status-indicator-dot"}),"Sistem Aktif")),e.createElement("span",{className:"header-date-text d-none d-md-block"},e.createElement("i",{className:"fa fa-calendar-alt me-1 text-muted"}),u)))),e.createElement("div",{className:"d-flex align-items-center gap-2 gap-sm-3"},e.createElement(s,{href:"/account/tagihan",className:"btn-quick-tagihan d-none d-sm-inline-flex",title:"Pusat Tagihan & Iuran"},e.createElement("i",{className:"fa fa-receipt text-emerald-600"}),e.createElement("span",null,"Tagihan & Iuran")),e.createElement(s,{href:"/",className:"btn-website-link d-none d-md-inline-flex",title:"Kunjungi Website Utama"},e.createElement("i",{className:"fa fa-globe"}),e.createElement("span",null,"Web IKATWI")),e.createElement("div",{className:"header-divider d-none d-sm-block"}),e.createElement(h,{title:e.createElement("div",{className:"user-profile-pill"},e.createElement("div",{className:"profile-avatar-box"},f),e.createElement("div",{className:"profile-text-wrap d-none d-sm-block"},e.createElement("div",{className:"profile-name-text",title:((w=a==null?void 0:a.user)==null?void 0:w.name)||"Anggota"},((o=a==null?void 0:a.user)==null?void 0:o.name)||"Anggota"),e.createElement("small",{className:"profile-role-text"},p)),e.createElement("i",{className:"fa fa-chevron-down profile-arrow-icon d-none d-sm-inline-block"})),id:"account-user-dropdown",className:"custom-user-dropdown",align:"end"},e.createElement("div",{className:"dropdown-user-header"},e.createElement("div",{className:"text-uppercase dropdown-label"},"Login Sebagai"),e.createElement("strong",{className:"dropdown-username",title:((N=a==null?void 0:a.user)==null?void 0:N.name)||"Anggota"},((I=a==null?void 0:a.user)==null?void 0:I.name)||"Anggota"),e.createElement("div",{className:"dropdown-user-id"},e.createElement("div",{className:"d-inline-flex align-items-center gap-1 px-2 py-1 rounded",style:{backgroundColor:"#f1f5f9",color:"#334155",fontSize:"0.72rem",fontWeight:600,fontFamily:"monospace",border:"1px solid #e2e8f0",marginTop:"4px"}},e.createElement("i",{className:"fa fa-id-card text-emerald-600 me-1",style:{fontSize:"0.75rem"}}),e.createElement("span",null,((j=a==null?void 0:a.user)==null?void 0:j.no_anggota)||((P=a==null?void 0:a.user)==null?void 0:P.email)||"ID Anggota")))),e.createElement(h.Item,{as:s,href:"/account/biodatas",className:"dropdown-nav-item"},e.createElement("div",{className:"dropdown-icon-frame",style:{backgroundColor:"#eff6ff",color:"#2563eb"}},e.createElement("i",{className:"fa fa-user-circle"})),e.createElement("div",null,e.createElement("div",{className:"fw-semibold text-dark"},"Profil Biodata"),e.createElement("small",{className:"text-muted"},"Kelola identitas anggota"))),e.createElement(h.Item,{as:s,href:"/account/tagihan",className:"dropdown-nav-item"},e.createElement("div",{className:"dropdown-icon-frame",style:{backgroundColor:"#ecfdf5",color:"#059669"}},e.createElement("i",{className:"fa fa-receipt"})),e.createElement("div",null,e.createElement("div",{className:"fw-semibold text-dark"},"Tagihan & Iuran"),e.createElement("small",{className:"text-muted"},"Cek & bayar iuran tahunan"))),e.createElement(h.Item,{as:s,href:"/account/ekta",className:"dropdown-nav-item"},e.createElement("div",{className:"dropdown-icon-frame",style:{backgroundColor:"#fffbeb",color:"#d97706"}},e.createElement("i",{className:"fa fa-id-card"})),e.createElement("div",null,e.createElement("div",{className:"fw-semibold text-dark"},"E-KTA Digital"),e.createElement("small",{className:"text-muted"},"Kartu tanda anggota resmi"))),e.createElement(h.Divider,{className:"my-1"}),e.createElement(h.Item,{onClick:r,className:"dropdown-nav-item text-danger"},e.createElement("div",{className:"dropdown-icon-frame",style:{backgroundColor:"#fef2f2",color:"#dc2626"}},e.createElement("i",{className:"fa fa-sign-out-alt"})),e.createElement("div",null,e.createElement("div",{className:"fw-bold text-danger"},"Keluar Sistem"),e.createElement("small",{className:"text-muted"},"Akhiri sesi portal"))))))),e.createElement("main",{className:"main-portal-content"},i),e.createElement("footer",{className:"portal-footer"},e.createElement("div",{className:"container-fluid d-flex flex-column flex-sm-row justify-content-between align-items-center gap-2"},e.createElement("span",null,"\xA9 ",new Date().getFullYear()," ",e.createElement("strong",null,"IKATWI")," (Ikatan Terapis Wicara Indonesia). All rights reserved."),e.createElement("span",{className:"text-muted",style:{fontSize:"0.75rem"}},"Sistem Informasi Keanggotaan Terpadu"))))),e.createElement("style",null,`
