import{u as c,R as e,H as s}from"./app.9bcc7c43.js";import{L as d}from"./Account.c619b06d.js";import"./sweetalert2.all.70bfe029.js";import{Q as p}from"./index.f61517e0.js";import"./Dropdown.45143daf.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
