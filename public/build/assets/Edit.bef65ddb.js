import{u as c,R as e,H as s}from"./app.1d91d38e.js";import{L as d}from"./Account.f380eda4.js";import"./sweetalert2.all.4377c9ee.js";import{Q as p}from"./index.44a7a09d.js";import"./Dropdown.83098e85.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
