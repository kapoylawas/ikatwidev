import{u as c,R as e,H as s}from"./app.4e2bc322.js";import{L as d}from"./Account.d7b21155.js";import"./sweetalert2.all.403e967b.js";import{Q as p}from"./index.954fc45c.js";import"./Dropdown.fc4d43dc.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
