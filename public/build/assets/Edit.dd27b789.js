import{u as c,R as e,H as s}from"./app.f41a7b80.js";import{L as d}from"./Account.11a7b2f0.js";import"./sweetalert2.all.3ebeda31.js";import{Q as p}from"./index.2e4871ff.js";import"./Dropdown.2942ee5c.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
