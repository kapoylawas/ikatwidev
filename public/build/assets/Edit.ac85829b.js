import{u as c,R as e,H as s}from"./app.be4e851e.js";import{L as d}from"./Account.7e3ac2cb.js";import"./sweetalert2.all.32233489.js";import{Q as p}from"./index.e1db70b4.js";import"./Dropdown.f6427490.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
