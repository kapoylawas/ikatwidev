import{u as s,R as e,H as p}from"./app.5cfc6ce5.js";import{L as u}from"./Account.1b1e7b90.js";import{Q as g}from"./index.f5de0b6b.js";import"./Dropdown.3b9c49f0.js";function I(){var n,a,l,i;const{biodata:t}=s().props,o=parseInt("100720".substring(2,4)),m=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][o],c=t.pengajuan.status,d=()=>{const r=window.open("","_blank");r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
        ...
        `),r.document.close()};return e.createElement(e.Fragment,null,e.createElement(p,null,e.createElement("title",null,"Formulir Mutasi Anggota - IKATWI"),e.createElement("style",null,`
                    @page {
                        size: A4;
                        margin: 2.5cm;
                    }
