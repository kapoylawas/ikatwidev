import{u as c,R as e,H as s}from"./app.eefea55c.js";import{L as d}from"./Account.db8b4c20.js";import"./sweetalert2.all.547950af.js";import{Q as p}from"./index.7f3ae1e0.js";import"./Dropdown.f72d10be.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
