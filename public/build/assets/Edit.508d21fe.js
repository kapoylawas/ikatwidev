import{u as c,R as e,H as s}from"./app.0adde45d.js";import{L as d}from"./Account.7dc68dc0.js";import"./sweetalert2.all.8f4a680b.js";import{Q as p}from"./index.0496bdc4.js";import"./Dropdown.1f0be90e.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
