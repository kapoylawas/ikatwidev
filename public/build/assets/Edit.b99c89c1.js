import{u as c,R as e,H as s}from"./app.a6fe9e4a.js";import{L as d}from"./Account.467473de.js";import"./sweetalert2.all.cfe473ae.js";import{Q as p}from"./index.22044a3f.js";import"./Dropdown.1d1c9b7a.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
