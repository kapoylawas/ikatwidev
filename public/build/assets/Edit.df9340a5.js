import{u as c,R as e,H as s}from"./app.8a56ea94.js";import{L as d}from"./Account.2ff57b4a.js";import"./sweetalert2.all.e3658c13.js";import{Q as p}from"./index.22143592.js";import"./Dropdown.435da44c.js";function w(){var a,l;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;console.log(t),t.user.no_anggota.slice(3,6);const i=parseInt("100720".substring(2,4)),o=["","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][i],n=t.status;console.log(n);const m=()=>{const r=window.open("","_blank");r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
