import{u as c,R as e,H as s}from"./app.2b163f03.js";import{L as d}from"./Account.1726aa53.js";import"./sweetalert2.all.44d3b6e6.js";import{Q as p}from"./index.5b22ba66.js";import"./Dropdown.ae685cec.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
