import{u as G,r as o,R as e,H as D,L as U}from"./app.73ab5af8.js";import{L}from"./Account.1cc4778d.js";import{Q as W}from"./index.b1f6a619.js";import{h as k}from"./html2canvas.esm.3d083717.js";import{S as T}from"./sweetalert2.all.26dc121f.js";import"./Dropdown.d0478698.js";function K({children:a}){const l=o.exports.useRef(null),[i,u]=o.exports.useState(1);return o.exports.useEffect(()=>{const s=()=>{if(!l.current)return;const t=l.current.clientWidth;if(t>0){const x=Math.min(1,t/650);u(x)}};s(),window.addEventListener("resize",s);let c=null;return typeof window.ResizeObserver<"u"&&l.current&&(c=new ResizeObserver(s),c.observe(l.current)),()=>{window.removeEventListener("resize",s),c&&c.disconnect()}},[]),e.createElement("div",{ref:l,className:"card-responsive-scaler",style:{width:"100%",maxWidth:"650px",height:`${Math.round(382*i)}px`,position:"relative",display:"flex",justifyContent:"center",alignItems:"flex-start",overflow:"hidden",margin:"0 auto"}},e.createElement("div",{style:{transform:`scale(${i})`,transformOrigin:"top center",width:"650px",height:"382px",flexShrink:0}},a))}function H(){const{biodata:a,transactions:l=[],statusAnggota:i,isPaid:u,unpaidYears:s=[],isAdminPreview:c=!1}=G().props,[t,x]=o.exports.useState(!1),[v,j]=o.exports.useState(""),f=o.exports.useRef(null),b=o.exports.useRef(null),z=o.exports.useRef(null),N=(i==null?void 0:i.status_anggota)||(a==null?void 0:a.status_anggota)||"Anggota Biasa",R=typeof u=="boolean"?u:c||N==="Anggota Kehormatan"||l.some(n=>n.status==="PAID"||n.status==="SUCCESS")&&(!s||s.length===0),A=new Date().getFullYear(),r=async(n="png",g="front")=>{try{x(!0),j(`${g}-${n}`);let d="",h="";const y=n==="jpeg"?"image/jpeg":"image/png",I=n==="jpeg"?"jpg":"png",w={scale:3,useCORS:!0,allowTaint:!0,backgroundColor:n==="jpeg"?"#ffffff":null,logging:!1};if(g==="front"){if(!f.current)throw new Error("Elemen kartu depan tidak ditemukan");h=`E-KTA-Depan-${(a==null?void 0:a.no_anggota)||(a==null?void 0:a.name)||"IKATWI"}`,d=(await k(f.current,w)).toDataURL(y,1)}else if(g==="back"){if(!b.current)throw new Error("Elemen kartu belakang tidak ditemukan");h=`E-KTA-Belakang-${(a==null?void 0:a.no_anggota)||(a==null?void 0:a.name)||"IKATWI"}`,d=(await k(b.current,w)).toDataURL(y,1)}else{if(!f.current||!b.current)throw new Error("Elemen kartu tidak ditemukan");h=`E-KTA-Lengkap-${(a==null?void 0:a.no_anggota)||(a==null?void 0:a.name)||"IKATWI"}`;const[m,P]=await Promise.all([k(f.current,w),k(b.current,w)]),S=30*3,p=document.createElement("canvas");p.width=m.width+P.width+S,p.height=Math.max(m.height,P.height);const E=p.getContext("2d");n==="jpeg"&&(E.fillStyle="#ffffff",E.fillRect(0,0,p.width,p.height)),E.drawImage(m,0,0),E.drawImage(P,m.width+S,0),d=p.toDataURL(y,1)}const C=document.createElement("a");C.download=`${h}.${I}`,C.href=d,C.click(),T.fire({title:"Berhasil!",text:`Kartu E-KTA (${g==="both"?"Lengkap":g==="front"?"Sisi Depan":"Sisi Belakang"}) berhasil diunduh murni format ${I.toUpperCase()}.`,icon:"success",timer:2e3,showConfirmButton:!1,toast:!0,position:"top-end"})}catch(d){console.error("Error generating E-KTA image:",d),T.fire({title:"Gagal Mengunduh",text:"Terjadi kesalahan saat memproses gambar E-KTA. Silakan coba kembali.",icon:"error"})}finally{x(!1),j("")}},B=()=>{window.print()};return e.createElement(L,null,e.createElement(D,{title:"Cetak E-KTA - IKATWI"}),e.createElement("div",{className:"container-fluid py-4 ekta-page-container"},e.createElement("div",{className:"header-banner-box p-4 rounded-4 mb-4 shadow-sm"},e.createElement("div",{className:"d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3"},e.createElement("div",{className:"d-flex align-items-center"},e.createElement("div",{className:"header-icon-wrap me-3 shadow"},e.createElement("i",{className:"fa fa-id-card fa-2x text-white"})),e.createElement("div",null,e.createElement("div",{className:"d-flex align-items-center gap-2 flex-wrap"},e.createElement("h4",{className:"mb-0 fw-bold header-main-title"},"Cetak & Unduh E-KTA"),e.createElement("span",{className:"badge-status-pill shadow-sm"},e.createElement("i",{className:"fa fa-check-circle me-1 text-emerald-600"}),N)),e.createElement("p",{className:"header-subtitle mb-0 mt-1"},"Kartu identitas resmi profesi Ikatan Terapis Wicara Indonesia (IKATWI) yang dapat diunduh (JPG/PNG) & dicetak."))),e.createElement("div",{className:"d-flex gap-2 flex-wrap flex-shrink-0"},(a==null?void 0:a.no_anggota)&&e.createElement("div",{className:"badge-no-anggota-banner shadow-sm"},e.createElement("i",{className:"fa fa-award text-emerald-600 me-2"}),e.createElement("span",null,"No. Anggota:")," ",e.createElement("strong",null,a.no_anggota))))),R?e.createElement(e.Fragment,null,e.createElement("div",{className:"card control-card rounded-4 shadow-sm mb-4"},e.createElement("div",{className:"card-body p-3 p-md-4"},e.createElement("div",{className:"d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3"},e.createElement("div",{className:"d-flex align-items-center gap-2.5"},e.createElement("span",{className:"toolbar-icon-pill shadow-sm"},e.createElement("i",{className:"fa fa-download text-primary"})),e.createElement("div",null,e.createElement("h6",{className:"fw-bold text-slate-900 mb-0"},"Opsi Unduh & Cetak Kartu"),e.createElement("small",{className:"text-slate-600"},"Format gambar HD (PNG / JPG 300 DPI) kartu murni tanpa tombol"))),e.createElement("div",{className:"d-flex align-items-center gap-2 flex-wrap"},e.createElement("div",{className:"btn-group shadow-sm"},e.createElement("button",{type:"button",onClick:()=>r("png","front"),disabled:t,className:"btn btn-sm btn-primary-custom fw-semibold d-inline-flex align-items-center gap-1.5 px-3 py-2"},t&&v==="front-png"?e.createElement("span",{className:"spinner-border spinner-border-sm",role:"status"}):e.createElement("i",{className:"fa fa-image"}),e.createElement("span",null,"Unduh Depan (PNG)")),e.createElement("button",{type:"button",onClick:()=>r("jpeg","front"),disabled:t,className:"btn btn-sm btn-outline-primary-custom px-2.5 py-2 fw-bold",title:"Unduh format JPG"},"JPG")),e.createElement("div",{className:"btn-group shadow-sm"},e.createElement("button",{type:"button",onClick:()=>r("png","back"),disabled:t,className:"btn btn-sm btn-teal-custom fw-semibold d-inline-flex align-items-center gap-1.5 px-3 py-2"},t&&v==="back-png"?e.createElement("span",{className:"spinner-border spinner-border-sm",role:"status"}):e.createElement("i",{className:"fa fa-qrcode"}),e.createElement("span",null,"Unduh Belakang (PNG)")),e.createElement("button",{type:"button",onClick:()=>r("jpeg","back"),disabled:t,className:"btn btn-sm btn-outline-teal-custom px-2.5 py-2 fw-bold",title:"Unduh format JPG"},"JPG")),e.createElement("div",{className:"btn-group shadow-sm"},e.createElement("button",{type:"button",onClick:()=>r("png","both"),disabled:t,className:"btn btn-sm btn-emerald-custom fw-semibold d-inline-flex align-items-center gap-1.5 px-3 py-2"},t&&v==="both-png"?e.createElement("span",{className:"spinner-border spinner-border-sm",role:"status"}):e.createElement("i",{className:"fa fa-layer-group"}),e.createElement("span",null,"Unduh Lengkap (PNG)")),e.createElement("button",{type:"button",onClick:()=>r("jpeg","both"),disabled:t,className:"btn btn-sm btn-outline-emerald-custom px-2.5 py-2 fw-bold",title:"Unduh format JPG Lengkap"},"JPG")),e.createElement("button",{type:"button",onClick:B,className:"btn btn-sm btn-print-custom fw-semibold d-inline-flex align-items-center gap-1.5 px-3 py-2 shadow-sm"},e.createElement("i",{className:"fa fa-print"}),e.createElement("span",null,"Cetak E-KTA")))))),e.createElement("div",{ref:z,className:"printable-cards-wrapper"},e.createElement("div",{className:"row g-4 justify-content-center"},e.createElement("div",{className:"col-12 col-xl-6 d-flex justify-content-center"},e.createElement("div",{className:"card-preview-box"},e.createElement("div",{className:"preview-box-header d-flex align-items-center justify-content-between mb-3"},e.createElement("span",{className:"badge-side-pill pill-front shadow-sm"},e.createElement("i",{className:"fa fa-id-card me-1.5"})," Sisi Depan (Front Side)"),e.createElement("div",{className:"d-flex gap-1.5"},e.createElement("button",{onClick:()=>r("png","front"),className:"btn btn-badge-action shadow-sm",title:"Unduh PNG Depan"},e.createElement("i",{className:"fa fa-download text-primary"}),e.createElement("span",null,"PNG")),e.createElement("button",{onClick:()=>r("jpeg","front"),className:"btn btn-badge-action shadow-sm",title:"Unduh JPG Depan"},e.createElement("i",{className:"fa fa-download text-secondary"}),e.createElement("span",null,"JPG")))),e.createElement("div",{className:"card-display-stage"},e.createElement(K,null,e.createElement("div",{ref:f,className:"ekta-card-front shadow"},e.createElement("div",{className:"card-avatar-container"},e.createElement("div",{className:"avatar-frame shadow-sm"},e.createElement("img",{src:(a==null?void 0:a.image)||"/assets/images/user.png",alt:a==null?void 0:a.name,className:"avatar-photo",onError:n=>{n.target.onerror=null,n.target.src="/assets/images/user.png"}}))),e.createElement("div",{className:"card-validity-container text-center"},e.createElement("span",{className:"validity-label"},"Berlaku Sampai :"),e.createElement("span",{className:"validity-date"},"31 DESEMBER ",A)),e.createElement("div",{className:"card-info-container"},e.createElement("div",{className:"info-row"},e.createElement("span",{className:"info-label"},"Nama"),e.createElement("span",{className:"info-colon"},":"),e.createElement("span",{className:"info-value text-uppercase fw-bold"},(a==null?void 0:a.name)||"-")),e.createElement("div",{className:"info-row"},e.createElement("span",{className:"info-label"},"Alamat"),e.createElement("span",{className:"info-colon"},":"),e.createElement("span",{className:"info-value address-value"},(a==null?void 0:a.alamat)||"-")),e.createElement("div",{className:"info-row"},e.createElement("span",{className:"info-label"},"No"),e.createElement("span",{className:"info-colon"},":"),e.createElement("span",{className:"info-value font-monospace fw-bold"},(a==null?void 0:a.no_anggota)||"-")),e.createElement("div",{className:"info-row"},e.createElement("span",{className:"info-label"},"Status"),e.createElement("span",{className:"info-colon"},":"),e.createElement("span",{className:"info-value"},N)))))))),e.createElement("div",{className:"col-12 col-xl-6 d-flex justify-content-center"},e.createElement("div",{className:"card-preview-box"},e.createElement("div",{className:"preview-box-header d-flex align-items-center justify-content-between mb-3"},e.createElement("span",{className:"badge-side-pill pill-back shadow-sm"},e.createElement("i",{className:"fa fa-qrcode me-1.5"})," Sisi Belakang (Back Side)"),e.createElement("div",{className:"d-flex gap-1.5"},e.createElement("button",{onClick:()=>r("png","back"),className:"btn btn-badge-action shadow-sm",title:"Unduh PNG Belakang"},e.createElement("i",{className:"fa fa-download text-teal"}),e.createElement("span",null,"PNG")),e.createElement("button",{onClick:()=>r("jpeg","back"),className:"btn btn-badge-action shadow-sm",title:"Unduh JPG Belakang"},e.createElement("i",{className:"fa fa-download text-secondary"}),e.createElement("span",null,"JPG")))),e.createElement("div",{className:"card-display-stage"},e.createElement(K,null,e.createElement("div",{ref:b,className:"ekta-card-back shadow"},e.createElement("div",{className:"card-qr-container"},e.createElement("div",{className:"qr-wrapper"},e.createElement(W,{value:a!=null&&a.no_anggota?`https://ikatwi.org/verify/${a.no_anggota}`:(a==null?void 0:a.name)||"IKATWI",size:120,renderAs:"canvas",level:"H"})))))))))),e.createElement("div",{className:"card notice-card rounded-4 shadow-sm mt-4"},e.createElement("div",{className:"card-body p-4"},e.createElement("div",{className:"d-flex align-items-start gap-3"},e.createElement("div",{className:"notice-icon-circle shadow-sm flex-shrink-0"},e.createElement("i",{className:"fa fa-shield-alt text-emerald-600"})),e.createElement("div",null,e.createElement("h6",{className:"fw-bold text-slate-900 mb-1"},"Informasi Keabsahan Kartu E-KTA"),e.createElement("p",{className:"text-slate-600 small mb-0",style:{lineHeight:1.6}},"E-KTA IKATWI ini adalah dokumen identitas keanggotaan profesi resmi terapis wicara Indonesia. QR Code pada bagian belakang kartu dapat dipindai langsung oleh instansi kesehatan atau masyarakat umum untuk memvalidasi keaslian status keanggotaan secara real-time di sistem pusat IKATWI.")))))):e.createElement("div",{className:"card unpaid-card rounded-4 shadow-sm mt-4 p-5 text-center"},e.createElement("div",{className:"unpaid-icon-wrap mb-3 shadow"},e.createElement("i",{className:"fa fa-credit-card text-amber-600"})),e.createElement("h4",{className:"fw-bold text-slate-900 mb-2"},"E-KTA Belum Dapat Diterbitkan"),e.createElement("p",{className:"text-slate-600 mx-auto mb-4",style:{maxWidth:"520px",fontSize:"0.92rem"}},"Untuk mengaktifkan dan mengunduh Kartu Tanda Anggota Elektronik (E-KTA) periode ",A,", silakan selesaikan pembayaran tagihan iuran tahunan Anda melalui Portal Pembayaran IKATWI."),e.createElement("div",{className:"d-flex justify-content-center gap-2"},e.createElement(U,{href:"/account/tagihan",className:"btn btn-pay-now rounded-pill px-4 py-2.5 fw-bold shadow"},e.createElement("i",{className:"fa fa-receipt me-1.5"}),e.createElement("span",null,"Buka Pusat Tagihan & Bayar Iuran"))))),e.createElement("style",null,`
                .ekta-page-container {
                    color: #1e293b;
                }
