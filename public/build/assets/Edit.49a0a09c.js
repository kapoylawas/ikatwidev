import{u as c,R as e,H as s}from"./app.488a485a.js";import{L as d}from"./Account.2067ce8b.js";import"./sweetalert2.all.0cc2dc0a.js";import{Q as p}from"./index.5e0f09bc.js";import"./Dropdown.9cd41d2f.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
