import{u as c,R as e,H as s}from"./app.c65f2c20.js";import{L as d}from"./Account.d0c104c0.js";import"./sweetalert2.all.133321d1.js";import{Q as p}from"./index.3409d3ab.js";import"./Dropdown.9b46f973.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
