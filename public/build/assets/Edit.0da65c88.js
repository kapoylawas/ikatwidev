import{u as c,R as e,H as s}from"./app.01201b19.js";import{L as d}from"./Account.8ed421ed.js";import"./sweetalert2.all.db6166db.js";import{Q as p}from"./index.36f31f39.js";import"./Dropdown.26c57905.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
