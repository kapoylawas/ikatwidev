import{u as c,R as e,H as s}from"./app.3444cc3c.js";import{L as d}from"./Account.b485c0c7.js";import"./sweetalert2.all.34d774c1.js";import{Q as p}from"./index.65adfccd.js";import"./Dropdown.237f85f1.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
