import{u as c,R as e,H as s}from"./app.c264c37d.js";import{L as d}from"./Account.e927295e.js";import"./sweetalert2.all.158896d8.js";import{Q as p}from"./index.e2b72d73.js";import"./Dropdown.f657d3fc.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
