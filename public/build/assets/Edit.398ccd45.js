import{u as c,R as e,H as s}from"./app.8926569f.js";import{L as d}from"./Account.529d567e.js";import"./sweetalert2.all.e5a0266a.js";import{Q as p}from"./index.f4a2e8cf.js";import"./Dropdown.8b44d017.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
