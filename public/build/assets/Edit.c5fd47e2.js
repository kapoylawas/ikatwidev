import{u as c,R as e,H as s}from"./app.be774077.js";import{L as d}from"./Account.5bc872d5.js";import"./sweetalert2.all.4feeb36d.js";import{Q as p}from"./index.f12de612.js";import"./Dropdown.fad9f999.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
