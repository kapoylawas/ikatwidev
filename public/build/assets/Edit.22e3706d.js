import{u as c,R as e,H as s}from"./app.5cfc6ce5.js";import{L as d}from"./Account.1b1e7b90.js";import"./sweetalert2.all.44514038.js";import{Q as p}from"./index.f5de0b6b.js";import"./Dropdown.3b9c49f0.js";function w(){var a,l;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;console.log(t),t.user.no_anggota.slice(3,6);const i=parseInt("100720".substring(2,4)),o=["","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][i],n=t.status;console.log(n);const m=()=>{const r=window.open("","_blank");r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
        ...
        `),r.document.close()};return e.createElement(e.Fragment,null,e.createElement(s,null,e.createElement("title",null,"Arsip Berkas Anggota - IKATWI"),e.createElement("style",null,`
                                @page {
                                    size: A4;
                                    margin: 2.5cm;
                                }
