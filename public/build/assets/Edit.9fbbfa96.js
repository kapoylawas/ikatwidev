import{u as c,R as e,H as s}from"./app.28e4ccc4.js";import{L as d}from"./Account.f311b3e0.js";import"./sweetalert2.all.9dcc1d3f.js";import{Q as p}from"./index.0da06237.js";import"./Dropdown.b1391ab7.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
