import{u as s,R as e,H as p}from"./app.1d39914e.js";import{L as g}from"./Account.c896fbae.js";import"./sweetalert2.all.6e76dcfd.js";import"./Dropdown.562bb0a8.js";function A(){var n,a,l,r;const{errors:u,provinces:E,cities:b,arsip:t}=s().props;console.log(t);const o=t.user.no_anggota.slice(3,6),m=parseInt("100720".substring(2,4)),c=["","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][m],d=()=>{const i=window.open("","_blank");i.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
        ...
        `),i.document.close()};return e.createElement(e.Fragment,null,e.createElement(p,null,e.createElement("title",null,"Arsip Berkas Anggota - IKATWI"),e.createElement("style",null,`
                                @page {
                                    size: A4;
                                    margin: 2.5cm;
                                }
