import{u as c,R as e,H as s}from"./app.2722f20f.js";import{L as d}from"./Account.a2ba3c71.js";import"./sweetalert2.all.45e1e6e0.js";import{Q as p}from"./index.e39b9a10.js";import"./Dropdown.5139b6cb.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
