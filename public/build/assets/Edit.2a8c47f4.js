import{u as c,R as e,H as s}from"./app.1cbe82db.js";import{L as d}from"./Account.5edf7db4.js";import"./sweetalert2.all.70d11cd1.js";import{Q as p}from"./index.dcbbf406.js";import"./Dropdown.e75a073b.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
