import{u as c,R as e,H as s}from"./app.dc0ffd6f.js";import{L as d}from"./Account.fc5d7727.js";import"./sweetalert2.all.b085cbed.js";import{Q as p}from"./index.825605a1.js";import"./Dropdown.9b289ba0.js";function w(){var n,a;const{errors:u,provinces:g,cities:E,arsip:t}=c().props;t.user.no_anggota.slice(3,6);const r=parseInt("100720".substring(2,4)),i=["","","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][r],o=t.status,m=()=>{const l=window.open("","_blank");l.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
