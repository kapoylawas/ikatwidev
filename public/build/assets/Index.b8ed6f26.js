import{u as s,R as e,H as g}from"./app.ba88c9a1.js";import{L as p}from"./Account.3b41befe.js";import"./Dropdown.ca614180.js";function f(){var a,l,i,r;const{biodata:t}=s().props,m=t.no_anggota.slice(0,3),c=parseInt("100720".substring(2,4)),n=["","I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"][c];console.log(n);const d=()=>{const o=window.open("","_blank");o.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
        ...
        `),o.document.close()};return e.createElement(e.Fragment,null,e.createElement(g,null,e.createElement("title",null,"Formulir Mutasi Anggota - IKATWI"),e.createElement("style",null,`
                    @page {
                        size: A4;
                        margin: 2.5cm;
                    }
