...
export default function VerifPengajuanDpcIndex() {
    ...
    return (
        <>
            <Head>
                <title>Verifikasi Pengajuan Mutasi DPC - IKATWI</title>
            </Head>
            <LayoutAccount>
                <div className="container-fluid py-4">
                                    ...
                                    <div className="row align-items-center">
                                        <div className="col">
                                            <h5 className="mb-0 text-primary">
                                                ...
                                                Verifikasi Pengajuan Pindah DPC
                                            </h5>
                    ...
                    <div className="col-md-6 col-12 mb-2">
                        <Search URL={"/account/verifPengajuanDpc"} />
                    </div>
