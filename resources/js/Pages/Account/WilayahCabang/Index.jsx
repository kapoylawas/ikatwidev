...
export default function WilayahCabangIndex() {
    ...
    const handleDelete = (id, name) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Inertia.delete(`/account/wilayah/${id}`, {
                    onSuccess: () => {
                        Swal.fire({
                            title: "Terhapus!",
                            text: "Data Wilayah DPW berhasil dihapus.",
                            icon: "success",
    ...
    return (
        <>
            <Head>
                <title>Manajemen Wilayah DPW - IKATWI</title>
            </Head>
            <LayoutAccount>
                <div className="container-fluid py-4 wilayah-admin-container">
                    ...
                    <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 p-4 rounded-4 shadow-sm border-0 header-banner-box">
                        <div className="d-flex align-items-center mb-3 mb-md-0">
                            <div className="header-icon-square me-3 shadow">
                                <i className="fa fa-map-marked-alt fa-2x text-white"></i>
                            </div>
                            <div>
                                <div className="d-flex align-items-center gap-2 mb-1">
                                    ...
                                    <span className="badge-level-pill">Tingkat Provinsi</span>
                                </div>
                                <p className="mb-0 text-slate-muted small">
                                    Kelola seluruh data sekretariat, pemetaan wilayah, kontak, dan ketua Dewan Pengurus Wilayah (DPW).
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="d-flex flex-wrap align-items-center gap-2">
                            ...
                            >
                                <i className="fa fa-map-signs me-1.5 text-primary"></i>
                                Buka Wilayah DPC
                            </Link>
                            ...
                            {hasAnyPermission(["wilayah.create"]) && (
                                <Link
                                    ...
                                    className="btn btn-add-wilayah rounded-pill px-4 py-2 fw-bold shadow"
                                >
                    ...
                    {/* Navigation Pills & Quick Filter Toolbar */}
                        ...
                        <div className="row g-3 align-items-center justify-content-between">
                                ...
                                <form onSubmit={handleSearchSubmit} className="position-relative">
                                    <div className="input-group search-input-group">
                                        ...
                                        <input
                                            ...
                                            placeholder="Cari provinsi / wilayah DPW..."
                                            value={search}
                            ...
                            <div className="col-12 col-md-6 col-lg-6 d-flex justify-content-md-end align-items-center gap-3">
                                <span className="badge-count-pill">
                                    <i className="fa fa-layer-group me-1.5 text-emerald-600"></i>
                                    Total <strong>{totalWilayah}</strong> Wilayah DPW
                                </span>
                                ...
                                <div className="btn-group view-switcher-group shadow-sm p-1 rounded-pill bg-slate-100" role="group">
                                    <button
                                        ...
                                        className={`btn btn-sm rounded-pill px-3 py-1.5 fw-semibold ${
                                            viewMode === "grid"
                                                ? "btn-white text-emerald-700 shadow-sm active-view"
                    ...
                    {/* Content Section: Grid Card (Web Portal Aesthetic) */}
                    {viewMode === "grid" && (
                                ...
                                wilayah.data.map((item, idx) => {
                                    ...
                                    return (
                                        <div key={idx} className="col-12 col-md-6 col-xl-4">
                                            <div className="card h-100 border-0 rounded-4 shadow-sm overflow-hidden portal-wilayah-card">
                                                {/* Card Header Top */}
                                                <div className="card-header border-0 py-3 px-4 d-flex justify-content-between align-items-center portal-card-header">
                                                    <div className="d-flex align-items-center gap-2.5 overflow-hidden">
                                                        <span className="dpw-badge-icon shadow-sm">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span className="text-slate-500 font-monospace" style={{ fontSize: "0.72rem" }}>
                                                                ID: DPW-{item.province_id || item.id}
                                                            </span>
                                                        </div>
                                                    </div>

                                                    <span className="badge-active-pill">
                                                        <i className="fa fa-check-circle me-1 text-emerald-600"></i> Aktif
                                                    </span>
                                                </div>
                                                ...
                                                <div className="card-body p-4 d-flex flex-column justify-content-between">
                                                    <div>
                                                        {/* Ketua Pengurus Box */}
                                                        <div className="p-3 rounded-3 mb-3 ketua-info-box d-flex align-items-center gap-3">
                                                            <div className="ketua-avatar-circle shadow-sm">
                                                    ...
                                                    <div className="pt-3 mt-3 border-top d-flex justify-content-between align-items-center">
                                                        <span className="text-slate-400 small" style={{ fontSize: "0.72rem" }}>
                                                            <i className="fa fa-calendar-check me-1"></i> Terdaftar Resmi
                                                        </span>

                                                        <div className="d-flex gap-1.5">
                                                            {hasAnyPermission(["wilayah.edit"]) && (
                                                                <Link
                                                                    href={`/account/wilayah/${item.id}/edit`}
                                                            ...
                                                            {hasAnyPermission(["wilayah.delete"]) && (
                                                                <button
                                                                    onClick={() => handleDelete(item.id, item.province?.name)}
                                ...
                                <div className="col-12">
                                    <div className="card border-0 rounded-4 shadow-sm p-5 text-center bg-white empty-state-box">
                                        ...
                                        <p className="text-slate-500 small mb-3">
                                            {search
                                                ? `Tidak ada data wilayah DPW yang cocok dengan kata kunci "${search}".`
                                                : "Belum ada data wilayah DPW yang ditambahkan ke sistem."}
                                        </p>
                                        {search && (
                                            <div>
                                    ...
                                    <table className="table table-hover align-middle mb-0">
                                        <thead className="table-thead-custom">
                                            <tr>
                                                ...
                                                <th className="py-3" style={{ width: "20%" }}>WILAYAH DPW</th>
                                                <th className="py-3" style={{ width: "18%" }}>KETUA DPW</th>
                                            ...
                                            {wilayah.data && wilayah.data.length > 0 ? (
                                                        ...
                                                        <tr key={idx} className="table-row-custom">
                                                            ...
                                                            <td>
                                                                <div className="d-flex align-items-center gap-2">
                                                                    <div className="table-dpw-icon">
                                                                        <i className="fa fa-landmark text-primary"></i>
                                                                    </div>
                                                                    <div>
                                                            ...
                                                            <td>
                                                                <div className="d-flex align-items-center gap-2">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <span className="text-emerald-700 fw-semibold" style={{ fontSize: "0.72rem" }}>
                                                                            Ketua Wilayah
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                ...
                                                <tr>
                                                    <td colSpan="6" className="text-center py-5 text-secondary">
                                                        ...
                                                        <span className="fw-medium">Belum ada data wilayah DPW tercatat.</span>
                                                    </td>
                                                </tr>
                                            )}
                                        </tbody>
